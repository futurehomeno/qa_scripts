...
def send_rasbpi_request(request, url, headers, data=None, sleep_time=5):
...
#
#
# resp = requests.post('http://{}/servos/{}/actions'.format(RASBPI_IP_KRK, MODESWITCH_HOME_SERVO_NO),
#                                  headers=headers, data=data_mode_switch_home)
# print("Status:" + str(resp.status_code))
# print("Resp:" + str(resp.json()))
# time.sleep(5)
#
# resp = requests.post('http://{}/servos/{}/actions'.format(RASBPI_IP_KRK, MODESWITCH_NIGHT_SERVO_NO),
#                                  headers=headers, data=data_mode_switch)
# print("Status:" + str(resp.status_code))
# print("Resp:" + str(resp.json()))
# time.sleep(5)
#
# resp = requests.post('http://{}/servos/{}/actions'.format(RASBPI_IP_KRK, MODESWITCH_AWAY_SERVO_NO),
#                                  headers=headers, data=data_mode_switch)
# print("Status:" + str(resp.status_code))
# print("Resp:" + str(resp.json()))
# time.sleep(5)
#
# resp = requests.post('http://{}/servos/{}/actions'.format(RASBPI_IP_KRK, MODESWITCH_VACATION_SERVO_NO),
...
# #################################################### CONTACTRON ##############################################
#
# resp = requests.post('http://{}/servos/{}/actions'.format(RASBPI_IP_KRK, CONTACTRON_SERVO_NO),
